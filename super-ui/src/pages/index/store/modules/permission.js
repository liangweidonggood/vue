...
let Permission = class Permission extends VuexModule {
    ...
    SET_ISADDROUTERS(state) {
        this.isAddRouters = state;
    }
    SET_MENUTABROUTERS(routers) {
...
__decorate([
    Mutation
], Permission.prototype, "SET_ISADDROUTERS", null);
__decorate([
    Mutation
], Permission.prototype, "SET_MENUTABROUTERS", null);
__decorate([
    Mutation
], Permission.prototype, "SET_ACTIVETAB", null);
__decorate([
    Action
], Permission.prototype, "GenerateRoutes", null);
__decorate([
    Action
], Permission.prototype, "SetIsAddRouters", null);
__decorate([
    Action
], Permission.prototype, "SetMenuTabRouters", null);
__decorate([
    Action
], Permission.prototype, "SetAcitveTab", null);
